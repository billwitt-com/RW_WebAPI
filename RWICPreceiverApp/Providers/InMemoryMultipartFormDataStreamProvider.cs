...
namespace RWICPreceiverApp.Providers
{
    public class InMemoryMultipartFormDataStreamProvider : MultipartStreamProvider
    {
        ...
        private StationImageUploadModel stationImageUploadModel = new StationImageUploadModel();
        ...
        /// Gets a <see cref="NameValueCollection"/> of form data passed as part of the multipart form data.  
        /// </summary>  
        public StationImageUploadModel UploadedStationImageUploadModel
        {
            get { return stationImageUploadModel; }
        }
